  ...
  return (
    <div>
      <Container className="flex justify-between flex-wrap lg:px-0 px-3 items-center">
        <div className="right md:order-1 order-2">
          ...
          <h1 className='font-In text-[#FFFFFF] lg:text-[48px] md:text-4xl sm:text-2xl text-xl font-bold lg:pt-[64px] md:pt-12 sm:pt-9 pt-7 md:pb-[9px] sm:pb-[7px] pb-1  max-w-[482px]'>HELLO I AM</h1>
        ...
        <div className="left md:order-2 order-1">
            <img src={image} alt="" />
        </div>
